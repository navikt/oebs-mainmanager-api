...
@Setter
@ToString
@Table(name = "XXRTV_MAINMANAGER_LOGG", schema = "XXRTV")
public class KallLogg {
	...
	@Id
	@SequenceGenerator(name = "XXRTV_MAINMANAGER_SEQ", sequenceName = "XXRTV_MAINMANAGER_SEQ", schema = "APPS", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "XXRTV_MAINMANAGER_SEQ")
