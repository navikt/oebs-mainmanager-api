...
public class KonteringsinfoService extends ObjektMaps {

	private static final String PLSQL_PROCEDURE = "xxrtv_restapi_oebs_ve_v1.xxrtv_hent_segmenter";

	private PlsqlProcedureRepository plsqlProcedureRepository;

	public KonteringsinfoService(PlsqlProcedureRepository plsqlProcedureRepository, ObjectMapper objectMapper) {
		super(objectMapper);
